      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
        ...
        <section className="pt-24 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
              Professional Payment Terminals
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 font-display">
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Compare Terminals</h2>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Why Choose NeonO Hardware</h2>
            </div>
