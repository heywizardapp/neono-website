-- ============================================
-- NeonO Academy - Seed Content (Part 2)
-- Additional Articles for Remaining Categories
-- ============================================

-- ============================================
-- Client Management (7 articles)
-- ============================================
...
-- Continue with remaining articles for brevity, including:
-- - Setting Up Loyalty Programs
-- - Managing Memberships
-- - Client Retention Strategies
-- - Handling Client Feedback
-- And all articles for POS & Payments, Marketing, Staff Management, Reports & Analytics, Advanced Features

-- ============================================
-- INSERT ARTICLE TAGS (for search optimization)
-- ============================================

INSERT INTO academy_article_tags (article_id, tag) VALUES
-- Getting Started tags
((SELECT id FROM academy_articles WHERE slug = 'creating-your-salon-profile'), 'setup'),
((SELECT id FROM academy_articles WHERE slug = 'creating-your-salon-profile'), 'profile'),
((SELECT id FROM academy_articles WHERE slug = 'creating-your-salon-profile'), 'business-info'),
((SELECT id FROM academy_articles WHERE slug = 'creating-your-salon-profile'), 'branding'),
((SELECT id FROM academy_articles WHERE slug = 'adding-your-first-team-member'), 'staff'),
((SELECT id FROM academy_articles WHERE slug = 'adding-your-first-team-member'), 'team'),
((SELECT id FROM academy_articles WHERE slug = 'adding-your-first-team-member'), 'permissions'),
((SELECT id FROM academy_articles WHERE slug = 'adding-your-first-team-member'), 'roles'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-services'), 'services'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-services'), 'pricing'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-services'), 'menu'),
((SELECT id FROM academy_articles WHERE slug = 'configuring-business-hours'), 'hours'),
((SELECT id FROM academy_articles WHERE slug = 'configuring-business-hours'), 'schedule'),
((SELECT id FROM academy_articles WHERE slug = 'configuring-business-hours'), 'availability'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-payment-methods'), 'payments'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-payment-methods'), 'deposits'),
((SELECT id FROM academy_articles WHERE slug = 'setting-up-payment-methods'), 'credit-card'),
((SELECT id FROM academy_articles WHERE slug = 'customizing-your-booking-page'), 'booking-page'),
((SELECT id FROM academy_articles WHERE slug = 'customizing-your-booking-page'), 'online-booking'),
((SELECT id FROM academy_articles WHERE slug = 'customizing-your-booking-page'), 'branding'),
((SELECT id FROM academy_articles WHERE slug = 'inviting-clients'), 'clients'),
((SELECT id FROM academy_articles WHERE slug = 'inviting-clients'), 'import'),
((SELECT id FROM academy_articles WHERE slug = 'inviting-clients'), 'migration'),
((SELECT id FROM academy_articles WHERE slug = 'your-first-appointment'), 'appointments'),
((SELECT id FROM academy_articles WHERE slug = 'your-first-appointment'), 'booking'),
((SELECT id FROM academy_articles WHERE slug = 'your-first-appointment'), 'checkout'),

-- Appointments tags
((SELECT id FROM academy_articles WHERE slug = 'managing-your-calendar'), 'calendar'),
((SELECT id FROM academy_articles WHERE slug = 'managing-your-calendar'), 'scheduling'),
((SELECT id FROM academy_articles WHERE slug = 'managing-your-calendar'), 'organization'),
((SELECT id FROM academy_articles WHERE slug = 'creating-manual-bookings'), 'booking'),
((SELECT id FROM academy_articles WHERE slug = 'creating-manual-bookings'), 'manual'),
((SELECT id FROM academy_articles WHERE slug = 'creating-manual-bookings'), 'appointments'),
((SELECT id FROM academy_articles WHERE slug = 'handling-walk-ins'), 'walk-ins'),
((SELECT id FROM academy_articles WHERE slug = 'handling-walk-ins'), 'last-minute'),
((SELECT id FROM academy_articles WHERE slug = 'appointment-reminders'), 'reminders'),
((SELECT id FROM academy_articles WHERE slug = 'appointment-reminders'), 'sms'),
((SELECT id FROM academy_articles WHERE slug = 'appointment-reminders'), 'notifications'),
((SELECT id FROM academy_articles WHERE slug = 'no-show-prevention'), 'no-shows'),
((SELECT id FROM academy_articles WHERE slug = 'no-show-prevention'), 'deposits'),
((SELECT id FROM academy_articles WHERE slug = 'no-show-prevention'), 'cancellation-policy'),
((SELECT id FROM academy_articles WHERE slug = 'recurring-appointments'), 'recurring'),
((SELECT id FROM academy_articles WHERE slug = 'recurring-appointments'), 'regular-clients'),
((SELECT id FROM academy_articles WHERE slug = 'recurring-appointments'), 'repeat-booking'),

-- Client Management tags
((SELECT id FROM academy_articles WHERE slug = 'adding-client-profiles'), 'clients'),
((SELECT id FROM academy_articles WHERE slug = 'adding-client-profiles'), 'profiles'),
((SELECT id FROM academy_articles WHERE slug = 'adding-client-profiles'), 'crm'),
((SELECT id FROM academy_articles WHERE slug = 'client-history-notes'), 'history'),
((SELECT id FROM academy_articles WHERE slug = 'client-history-notes'), 'notes'),
((SELECT id FROM academy_articles WHERE slug = 'client-history-notes'), 'formulas'),
((SELECT id FROM academy_articles WHERE slug = 'client-communication-tools'), 'communication'),
((SELECT id FROM academy_articles WHERE slug = 'client-communication-tools'), 'email'),
((SELECT id FROM academy_articles WHERE slug = 'client-communication-tools'), 'sms'),
((SELECT id FROM academy_articles WHERE slug = 'client-communication-tools'), 'marketing');

-- Update read_time_minutes based on content length
UPDATE academy_articles 
SET read_time_minutes = GREATEST(1, LENGTH(content) / 1000);
